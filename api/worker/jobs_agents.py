"""
api/worker/jobs_agents.py — ARQ jobs: single-candidate agent pipeline (SPEC-07).

Single-candidate agent pipeline jobs (SPEC-07 S-07.7)
-----------------------------------------------------
...
Batch-mode jobs live in api/worker/jobs_agents_batch.py.
